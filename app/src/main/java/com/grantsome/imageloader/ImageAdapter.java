...
public class ImageAdapter extends BaseAdapter {
    ...
    public void addList(List<ResultBean> resultBeanList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView mImageView = viewHolder.imageView;
        ResultBean resultBean = mResultBeanList.get(position);
        String url = resultBean.getUrl();
        Log.d("Adapter","Url"+url);

        final Object uri = getItem(position);
        mImageView.setTag(uri);
        mImageLoader = ImageLoader.get(mContext,url,mImageView);
